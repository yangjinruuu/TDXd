...
#!pip install "numba>=0.54" shap==0.48.0 -i https://pypi.tuna.tsinghua.edu.cn/simple
...
import os
# 切换到目标目录
os.chdir("/home/data/t180521/YJR/TDXd")
# 验证是否切换成功
print("当前目录:", os.getcwd()) 

import pandas as pd
# 读取 CSV 文件并存储为变量 data
data = pd.read_csv("数据/train_data_notscaled.csv")
# 查看前 5 行数据
print(data.head())
...
with st.form("prediction_form"):
    ...
    if submitted:
        ...
        # 预测概率
        try:
            proba = model.predict_proba(input_data)[0][1]  # 获取疾病进展的概率
